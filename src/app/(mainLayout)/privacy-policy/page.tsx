...
const sections = [
  ...
  },
  {
    title: "Contact Us",
    content:
      "If you have any questions about this Privacy Policy, please contact us at anaadevelopersltd@gmail.com or call at: +8801738399899, 117, 2/4 Shahajahan Market Road, Dhaka.",
  },
];
      ...
      <Container maxWidth="md" sx={{ py: 8 }}>
        <Paper elevation={3} sx={{ p: 4, borderRadius: 2 }}>
          ...
          <Typography variant="body1" paragraph>
            At Anaa Developers Ltd, we are committed to protecting your privacy
