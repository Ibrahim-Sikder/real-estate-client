...
const Floor = () => {
  const floor = [
    ...
    { id: 4, image: floor4, title: "Assure Murshed Heights 1st Floor Plan" },
    {
      id: 5,
      image: floor5,
      title: "Assure Murshed Heights Axonometric View Type-A",
    },
    {
      id: 6,
      image: floor6,
      title: "Assure Murshed Heights Axonometric View Type-B",
    },
    { id: 7, image: floor7, title: "Assure Murshed Heights Floor Plan Type-B" },
    {
      id: 8,
      image: floor8,
      title: "Assure Murshed Heights Typical Floor Plan Plan Option 01",
    },
  ];
