...
const sections = [
  ...
  },
  {
    ...
    content:
      "If you have any questions about these Terms and Conditions, please contact us at anaadevelopersltd@gmail.com or call at: +8801738399899, 117, 2/4 Shahajahan Market Road, Dhaka.",
  },
];
      ...
      <Container maxWidth="md" sx={{ py: 8 }}>
        <Paper elevation={3} sx={{ p: 4, borderRadius: 2 }}>
          ...
          <Typography variant="body1" paragraph textAlign="center">
            Welcome to Anaa Developers Ltd. These Terms and Conditions govern
